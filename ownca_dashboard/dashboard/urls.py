...
urlpatterns = [
    ...
    path('cas/import/', views.ca_import_view, name='ca_import'),
    ...
    path('cas/<uuid:ca_uuid>/export_p12', views.ca_export_p12_view, name='ca_export_p12'),
    ...
    path('system/cryptopro/', views.cryptopro_view, name='cryptopro'),
    path('api/cryptopro/status/', views.cryptopro_status_api, name='cryptopro_status'),
