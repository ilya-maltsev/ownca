...
## CryptoPro CSP panels

When CryptoPro is baked into the image, this page also shows **Provider
status**, **DRBG gamma** and **License**. With the integration enabled they
replace the "Crypto backend" panel: the provider signs then, not openssl. See
